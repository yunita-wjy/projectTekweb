            ...
            <!-- CONTENT PAGE -->
             <div class="container px-4">
                ...
                <div class="row d-flex align-items-center g-3">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12"> 
                        <form class="d-flex">
                            <input class="form-control me-2" type="search" placeholder="Search Showtimes (Movie)" aria-label="Search">
                    ...
                    <div class="card-body px-4">
                        <form>
                            <div class="row align-items-center mb-3 mt-1">
                                ...
                                <div class="col-sm-9">
                                    <select id="movieSelect" class="form-select">
                                        ...
                                        <!-- DROPDOWN DARI LIST MOVIE -->
                                        <option value="1" data-duration="120">Avengers</option> 
                                        <option value="2" data-duration="150">Twilight</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row align-items-center mb-3 mt-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" id="showing-date" name="showing-date" class="form-control" style="width: 200px;">
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center mb-3 mt-3">
                                ...
                                <div class="col-sm-9">
                                    <input id="duration" class="form-control" type="text" readonly>
                                </div>
                            </div>
                            <div class="row align-items-center mb-3 mt-3">
